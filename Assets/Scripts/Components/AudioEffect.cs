...
[System.Serializable]
public class AudioSetup : IAudioSetup
{
...
public class AudioEffect : MonoBehaviour
{
    ...
    private void PlayClip(int clipIndex)
    {
        ...
        if ((_currentSetup.Repeat == true && _playCount < _currentSetup.RepeatPlayCount) || (_currentSetup.RepeatPlayCount == -1 && _currentSetup.Repeat == true))
        {
